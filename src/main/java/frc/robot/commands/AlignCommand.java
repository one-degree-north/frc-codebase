...
public class AlignCommand extends CommandBase {
  ...
  public AlignCommand(ODN_HolonomicDrivebase drive, LimelightSubsystem limelight, HoodSubsystem hood, Function<Double, Double> attenuationFunction, Function<Double, Double> hoodFunction, XboxController joystick) {
    this.m_drive = drive;
